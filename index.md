...
<script type="text/JavaScript">
    ...
    <form style="width: 500px" action="action">
...
<div><input type="button" onclick="showMessage()" value="submit" /></div>
</form>


<p style="text-align: left;"> <strong>Click "Submit" to generate an announcement, and copy/paste the following text to SL Travelers Group IM:</strong> <br></p><div class="author-box">
